...
```
npm create cloudflare@latest -- --template=cloudflare/templates/hidden-wood-d16f
```

A live public deployment of this template is available at [https://hidden-wood-d16f.templates.workers.dev](https://hidden-wood-d16f.templates.workers.dev)
